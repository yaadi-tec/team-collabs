...
Play AI is a real-time collaborative system design workspace. Users describe a system in plain english, an AI agent maps that system into a shared canvas, collaborators refine the architecture, and the app generates a technical specification from the resulting graph.
...
5. User prompts the AI to generate an initial architecture.
6. AI generates nodes and edges in the shared canvas.
7. Collaborators edit and refine the desing.
